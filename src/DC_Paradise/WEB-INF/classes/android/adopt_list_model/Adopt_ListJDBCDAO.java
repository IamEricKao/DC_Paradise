...
public class Adopt_ListJDBCDAO implements Adopt_ListDAO_interface {
	...
	private static final String GET_ALL_STMT = 
		"SELECT Adopt_List_No, Adopt_Project_No, Adopter_No, Real_Name, Phone, Age, ID_Card, Address, Email, Date_Of_Application, Sex, Status FROM ADOPT_LIST order by Adopt_List_No DESC";
	private static final String GET_ONE_STMT = 
		"SELECT Adopt_List_No, Adopt_Project_No, Adopter_No, Real_Name, Phone, Age, ID_Card, Address, Email, Date_Of_Application, Sex, Status FROM ADOPT_LIST where Adopt_List_No = ?";
...
//	@Override
//	public void insert(Adopt_ListVO adopt_listVO) {
//
//		Connection con = null;
//		PreparedStatement pstmt = null;
//
...
//			pstmt.setString(7, adopt_listVO.getAddress());
//			pstmt.setString(8, adopt_listVO.getEmail());
//			pstmt.setString(9, adopt_listVO.getSex());
//			pstmt.setDate  (10, adopt_listVO.getDate_Of_Application());
//			pstmt.setInt   (11, adopt_listVO.getStatus());
//			
//			pstmt.executeUpdate();
...
//	@Override
//	public void update(Adopt_ListVO adopt_listVO) {
//
//		Connection con = null;
//		PreparedStatement pstmt = null;
//
...
//	@Override
//	public Adopt_ListVO findByPrimaryKey(String  Adopt_List_No) {
//
//		Adopt_ListVO adopt_listVO = null;
//		Connection con = null;
//		PreparedStatement pstmt = null;
...
//	@Override
//	public List<Adopt_ListVO> getAll() {
//		List<Adopt_ListVO> list = new ArrayList<Adopt_ListVO>();
//		Adopt_ListVO adopt_listVO = null;
//
//		Connection con = null;
//		PreparedStatement pstmt = null;
...
//				adopt_listVO.setDate_Of_Application(rs.getDate("Date_Of_Application"));
//				adopt_listVO.setStatus(rs.getInt("Status"));
//				list.add(adopt_listVO); // Store the row in the list
//			}
//
//			// Handle any driver errors
//		} catch (ClassNotFoundException e) {
...
//		adopt_listVO1.setAddress("新竹市東區中興十路80號");
//		adopt_listVO1.setEmail("Areamithat1959@gmail.com");
//		adopt_listVO1.setSex("男");
//		adopt_listVO1.setDate_Of_Application(java.sql.Date.valueOf("2018-08-11"));
//		adopt_listVO1.setStatus(0);
//		dao.insert(adopt_listVO1);
...
//		dao.delete("APL0012");
		...
		//查詢
//		List<Adopt_ListVO> adopt_listVO3 = dao.findBy_Adopt_Project_No("AP0007");
//		for(Adopt_ListVO adopt_List : adopt_listVO3) {
//			System.out.print(adopt_List.getAdopt_List_No() + ",");
//			System.out.print(adopt_List.getAdopt_Project_No() + ",");
//			System.out.print(adopt_List.getAdopter_No() + ",");
//			System.out.print(adopt_List.getReal_Name() + ",");
//			System.out.print(adopt_List.getPhone() + ",");
//			System.out.print(adopt_List.getAge() + ",");
//			System.out.print(adopt_List.getID_Card() + ",");
//			System.out.print(adopt_List.getAddress() + ",");
//			System.out.print(adopt_List.getEmail() + ",");
//			System.out.print(adopt_List.getSex() + ",");
//			System.out.print(adopt_List.getDate_Of_Application() + ",");
//			System.out.println(adopt_List.getStatus());
//		}
