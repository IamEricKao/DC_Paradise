package com.example.dc_para.task;
...
public class ImageTask extends AsyncTask<Object, Integer, Bitmap> {
    ...
    private String url, Adopt_Project_No;
    ...
    public ImageTask(String url, String Adopt_Project_No, int imageSize) {
        this(url, Adopt_Project_No, imageSize, null);
    }

    public ImageTask(String url, String Adopt_Project_No, int imageSize, ImageView imageView) {
        this.url = url;
    ...
    protected Bitmap doInBackground(Object... objects) {
        ...
        jsonObject.addProperty("Adopt_Project_No", Adopt_Project_No);
